...
class Step extends Component {
  ...
  render() {
    const everyFour = (this.props.step + 1) % 4 === 0 ? styles.everyFour : '';
    const stepStyle = this.props.loop[this.props.step] ? `${styles.step} ${styles.on} ${everyFour}` : `${styles.step} ${styles.off} ${everyFour}`;
